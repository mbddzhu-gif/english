class App {
    ...
    async _onRecordingComplete() {
        ...
        try {
            ...
            const audioBase64 = XunfeiSpeech.int16ArrayToBase64(this._pcmData);
        ...
        try {
            ...
            processor.onaudioprocess = (e) => {
                ...
                if (this._sceneIatConnected && this.xunfei.iatWs && this.xunfei.iatWs.readyState === WebSocket.OPEN) {
                    const base64Audio = XunfeiSpeech.int16ArrayToBase64(int16Data);
